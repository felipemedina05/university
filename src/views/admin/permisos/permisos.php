                        ...
                        <tbody>
                            <?php foreach ($permisos as $permiso) { ?>
                                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="/editaPermiso?id=<?= $permiso["id"] ?>" class="text-blue-500 hover:underline">Editar</a>
                                    </td>
                                </tr>
                            <?php } ?>
                            <!-- Modal de edición -->
                                            ...
                                            <form class="space-y-6" action="/updateClase" method="post">
                                                <div>
                                                    ...
                                                    <?php foreach ($clases as $clase) { ?>
                                                            <option value="<?=$clase['rol_id']?>"><?=$clase['rol']?></option>
                                                        <?php } ?>
                                                ...
                                                <div class="flex mt-5 ml-96 gap-1 justify-end">
                                                    <a href="/permisos" type="reset" class="w-full text-white bg-gray-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-gray-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Close</a>
                                                    <button type="submit" class="w-full text-white bg-blue-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Guardar cambios</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
