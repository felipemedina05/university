            ...
            <div class="h-full px-3 py-4 overflow-y-auto dark:bg-gray-50 bg-gray-800">
                <ul class="space-y-2 font-medium">
                    ...
                    <li class=" border-b border-white flex items-center p-2 dark:text-gray-900  text-white">
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">Alumnor</span>


                    </li>
                    <li class=" flex items-center p-2 dark:text-gray-900 rounded-lg text-white">

                        <h3 class="flex-1 ml-3 whitespace-nowrap">Menu Alumno</h3>
                    ...
                    <li>
                        <a href="/src/views/maestro/maestro.php" class="flex items-center p-2 dark:text-gray-900 rounded-lg text-white dark:hover:bg-gray-100 hover:bg-gray-700 group">
                    ...
                    <li>
                        <a href="/src/views/alumno/alumno.php" class="flex items-center p-2 dark:text-gray-900 rounded-lg text-white dark:hover:bg-gray-100 hover:bg-gray-700 group">
